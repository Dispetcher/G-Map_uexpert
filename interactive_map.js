...
const redGreenIcon = {url: 'Imgs/redGreen.png'};
...
/*Ссылки на статьи о станциях метро*/
const stLinks = [
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/jugo-zapadnaja-spb/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/metro-prospekt-slavy-spb/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/stantsiya-dunajskij-prospekt-peterburgskogo-metro/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/stantsiya-yuzhnaya-shushary-spb/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/teatralnaya-stroitelstvo/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/metro-bolshoj-prospekt-spb/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/stantsiya-novokrestovskaya/',
'https://undergroundexpert.info/metropoliteny-mira-i-rf/stroitelstvo-metro/stantsiya-begovaya-spb/'
];
...
'</div>'],
['<h3 class="content__header--transfer"><a href="'+ stLinks[6] + '">Станция метро «Новокрестовская 1»</a></h3>'+'<div>'+ contL3[1] +'</div>'+
...
/*******Описание пересадочных узлов для СТРОЯЩИХСЯ и ПРОЕКТИРУЕМЫХ*******/
/************************************************************************/
const contCPTransfL=[
['<h3 class="content__header--transfer">Станция метро «Площадь Восстания»</h3>'+'<div>'+ contL1[9] +'</div>'+
'<h3 class="content__header--transfer">Станция метро «Маяковская»</h3>'+'<div>'+ contL3[5] +'</div>'+
...
['Станция метро «Беговая»', {lat: 59.987998, lng: 30.202578}, contL3[0], greenIcon, greenLine, lop, lw, 0, stLinks[7]],
['Станция метро «Новокрестовская 1»', {lat: 59.971779, lng: 30.211776}, contL3[1], emptyIcon, greenLine, lop, lw, 0, stLinks[6]],
...
['Станция метро «Большой проспект»', {lat: 59.930386, lng: 30.261608}, contConstrL4[0], emptyIcon, orangeLine, cplop, cplw, 1, stLinks[5]],
['Станция метро «Театральная»', {lat: 59.925180, lng: 30.297236}, contConstrL4[1], cOrangeIcon, orangeLine, cplop, cplw, 1,stLinks[4]],
...
['Станция метро «Проспект Славы»', {lat: 59.856219, lng: 30.396560}, contConstrL5[0], cVioletIcon, violetLine, cplop, cplw, 1, stLinks[1]],
['Станция метро «Дунайская»', {lat: 59.839171, lng: 30.410844}, contConstrL5[1], cVioletIcon, violetLine, cplop, cplw, 1, stLinks[2]],
['Станция метро «Южная»', {lat: 59.822998, lng: 30.430662},contConstrL5[2], cVioletIcon, violetLine, cplop, cplw, 1,stLinks[3]]
];
...
['Станция метро «Юго-западная»', {lat: 59.859239, lng: 30.230442}, contConstrL6[1], cBrownIcon, greyLine, cplop, cplw, 1, delRenL6, stLinks[0]],
...
const l7st = [
['Пересадочный узел «Лесная 1/2»', {lat: 59.984789, lng: 30.344253}, contProspL7[0], planRedIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Станция метро «Кантемировская»', {lat: 59.980808, lng: 30.330515}, contProspL7[1], planIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Петроградская 1/2»', {lat: 59.966413, lng: 30.311513}, contProspL7[2], planBlueIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Спортивная 1/2»', {lat: 59.951835, lng: 30.290691}, contProspL7[3], planVioletIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Василеостровская 1/2»', {lat: 59.942669, lng: 30.278136}, contProspL7[4], planGreenIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Горный институт / Большой проспект 2»', {lat: 59.930386, lng: 30.261608}, contProspL7[5], planCOrangeIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Станция метро «Двинская»', {lat: 59.909501, lng: 30.254303}, contProspL7[6], planIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Нарвская 1/2»', {lat: 59.901178, lng: 30.274983}, contProspL7[7], planRedIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Броневая 1/2»', {lat: 59.876138, lng: 30.304550}, contProspL7[8], planPBrownIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Парк Победы 1/2»', {lat: 59.866232, lng: 30.321752}, contProspL7[9], planBlueIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Станция метро «Витебский проспект»', {lat: 59.865323, lng: 30.356574}, contProspL7[10], planIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Международная 1/2»', {lat: 59.870227, lng: 30.379399}, contProspL7[11], planVioletIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Станция метро «Фарфоровская»', {lat: 59.880034, lng: 30.403531}, contProspL7[12], planIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Елизаровская 1/2»', {lat: 59.896690, lng: 30.423680}, contProspL7[13], planGreenIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
...
['Пересадочный узел «Ладожская 1/2»', {lat: 59.932498, lng: 30.439265}, contProspL7[15], planOrangeIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Станция метро «Большеохтинская»', {lat: 59.943242, lng: 30.413506}, contProspL7[16], planIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
['Пересадочный узел «Полюстровский проспект 1/2»', {lat: 59.959525, lng: 30.414923}, contProspL7[17], planIcon, ligthGrLine, cplop, cplw, 1, delRenL7],
...
['Пересадочный узел «Лесная 1/2»', {lat: 59.984789, lng: 30.344253}, contProspL7[0], emptyIcon, ligthGrLine, cplop, cplw, 1, delRenL7]
];
...
['Станция метро «Площадь Восстания»', {lat: 59.931589, lng: 30.360368}, contL1[9], emptyIcon, redLine, lop, lw, 0],
['Станция метро «Владимирская»', {lat: 59.927751, lng: 30.347135}, contL1[10], emptyIcon, redLine, lop, lw, 0],
['Станция метро «Пушкинская»', {lat: 59.922076, lng: 30.331756}, contL1[11], emptyIcon, redLine, lop, lw, 0],
['Станция метро «Технологический институт»', {lat: 59.916281, lng: 30.318447}, contL1[12], emptyIcon, redLine, lop, lw, 0],
...
['Станция метро «Кировский завод»', {lat: 59.879802, lng: 30.261333}, contL1[15], emptyIcon, redLine, lop, lw, 0],
['Станция метро «Автово»', {lat: 59.867294, lng: 30.261240}, contL1[16], redIcon, redLine, lop, lw, 0],
...
const l3c = [
['Станция метро «Беговая»', {lat: 59.987998, lng: 30.202578}, contL3[0], greenIcon, greenLine, lop, lw, 0, stLinks[7]],
['Станция метро «Новокрестовская 1»', {lat: 59.972948, lng: 30.211208}, contL3[1], greenIcon, greenLine, lop, lw, 0, stLinks[6]],
['Станция метро «Приморская»', {lat: 59.948459, lng: 30.234463}, contL3[2], greenIcon, greenLine, lop, lw, 0],
...
const l4c = [
['Станция метро «Большой проспект»', {lat: 59.930386, lng: 30.261608}, contConstrL4[0], cOrangeIcon, orangeLine, cplop, cplw, 1, stLinks[5]],
['Станция метро «Театральная»', {lat: 59.925180, lng: 30.297236}, contConstrL4[1], cOrangeIcon, orangeLine, cplop, cplw, 1, stLinks[4]],
['Станция метро «Спасская»', {lat: 59.926731, lng: 30.317583}, contL4[0], emptyIcon, orangeLine, lop, lw, 0],
['Станция метро «Достоевская»', {lat: 59.927751, lng: 30.347135}, contL4[1], emptyIcon, orangeLine, lop, lw, 0],
...
const l6c = [
['Станция метро «Путиловская»', {lat: 59.879802, lng: 30.261333}, contConstrL6[0], emptyIcon, brownLine, cplop, cplw, 1, 10],
['Станция метро «Юго-западная»', {lat: 59.859239, lng: 30.230442}, contConstrL6[1], cBrownIcon, brownLine, cplop, cplw, 1, 10, stLinks[0]]
];
...
const l4p = [
['Станция метро «Новокрестовская 2»', {lat: 59.971779, lng: 30.211776}, contPrL4[0], emptyIcon, orangeLine, cplop, cplw, 1, 8],
...
['Станция метро «Большой проспект»', {lat: 59.930386, lng: 30.261608}, contConstrL4[0], cOrangeIconSm, orangeLine, lop, cplw, 1, 8, stLinks[5]],
['Станция метро «Театральная»', {lat: 59.925180, lng: 30.297236}, contConstrL4[1], cOrangeIconSm, orangeLine, lop, cplw, 1, 8, stLinks[4]],
['Станция метро «Спасская»', {lat: 59.926731, lng: 30.317583}, contL4[0], emptyIcon, orangeLine, lop, lw, 0, 8],
['Станция метро «Достоевская»', {lat: 59.927751, lng: 30.347135}, contL4[1], emptyIcon, orangeLine, lop, lw, 0, 8],
['Станция метро «Лиговский проспект»', {lat: 59.920985, lng: 30.354594}, contL4[2], orangeIcon, orangeLine, lop, lw, 0, 8],
['Станция метро «Площадь Ал. Невского»', {lat: 59.924040, lng: 30.384129}, contL4[3], emptyIcon, orangeLine, lop, lw, 0, 8],
...
['Станция метро «Бухарестская»', {lat: 59.883738, lng: 30.369136}, contL5[10], violetIcon, violetLine, lop, lw, 0],
['Станция метро «Международная»', {lat: 59.870227, lng: 30.379399}, contL5[11], violetIcon, violetLine, lop, lw, 0],
['Станция метро «Проспект Славы»', {lat: 59.856219, lng: 30.396560}, contConstrL5[0], cVioletIconSm, violetLine, lop, cplw, 1, stLinks[1]],
['Станция метро «Дунайская»', {lat: 59.839171, lng: 30.410844}, contConstrL5[1], cVioletIconSm, violetLine, lop, cplw, 1,stLinks[2]],
['Станция метро «Южная»', {lat: 59.822998, lng: 30.430662}, contConstrL5[2], cVioletIconSm, violetLine, lop, cplw, 1,stLinks[3]]
];

const l6p = [
['Станция метро «Каретная»', {lat: 59.914543, lng: 30.349430}, contPrL6[0], emptyIcon, brownLine, cplop, cplw, 1, 10],
['Станция метро «Боровая»', {lat: 59.902969, lng: 30.329868}, contPrL6[1], pBrownIcon, brownLine, cplop, cplw, 1, 10],
['Станция метро «Заставская»', {lat: 59.891733, lng: 30.318155}, contPrL6[2], emptyIcon, brownLine, cplop, cplw, 1, 10],
['Станция метро «Броневая»', {lat: 59.876138, lng: 30.304550}, contPrL6[3], pBrownIcon, brownLine, cplop, cplw, 1, 10],
['Станция метро «Путиловская»', {lat: 59.879802, lng: 30.261333}, contConstrL6[0], emptyIcon, brownLine, lop, cplw, 1, 10],
['Станция метро «Юго-западная»', {lat: 59.859239, lng: 30.230442}, contConstrL6[1], cBrownIconSm, brownLine, lop, cplw, 1, 10, stLinks[0]]
];
/*======================================*/
/*======================================*/
...
/*Блок пересадочных узлов для отображения в блоке СТРОЯЩИЕСЯ*/
/*************************************************************/
const lCTransfer=[
['Пересадочный узел «Площадь Восстания»/ «Маяковская»', {lat: 59.931589, lng: 30.360368}, contCPTransfL[0], redGreenIcon],
['Пересадочный узел «Владимирская»/ «Достоевская»', {lat: 59.927751, lng: 30.347135}, contTransfL[1], redOrangeIcon],
['Пересадочный узел «Пушкинская»/ «Звенигородская»', {lat: 59.922076, lng: 30.331756}, contTransfL[2], redVioletIcon],
['Пересадочный узел «Технологический институт 1/2»', {lat: 59.916281, lng: 30.318447}, contTransfL[3], redBlueIcon],
['Пересадочный узел «Кировский завод»/ «Путиловская»', {lat: 59.879802, lng: 30.261333}, contTransfL[4], redCBrownIcon],
...
/*Блок пересадочных узлов для отображения в блоке ПРОЕКТИРУЕМЫЕ, вместе со СТРОЯЩЕМИСЯ станциями*/
/*************************************************************/
const lPTransfer=[
['Пересадочный узел «Московские ворота»/ «Заставская»', {lat: 59.891733, lng: 30.318155}, contTransfL[7], bluePBrownIcon],
['Пересадочный узел «Планерная»/ «Шуваловский проспект»', {lat: 60.025094, lng: 30.228572}, contTransfL[8], pGreenPViolIcon],
...
const l3add = [
['Станция метро «Планерная»', {lat: 60.025094, lng: 30.228572}, contPrL3[0], pGreenIcon],
...
const l4add = [
['Станция метро «Новокрестовская 2»', {lat: 59.971779, lng: 30.211776}, contPrL4[0], pOrangeIcon],
...
['Станция метро «Каретная»', {lat: 59.914543, lng: 30.349430}, contPrL6[0], pBrownIcon],
...
function dropConstr(infowindow){
  ...
  dropmarker(infowindow, lCTransfer);
}
...
function dropProject(infowindow){
  ...
  dropline6(infowindow, l4p);
  dropline(infowindow, l5p);
  dropline6(infowindow, l6p);
  dropmarker(infowindow, lCTransfer);
  dropmarker(infowindow, lPTransfer);
}
...
function dropmarker(infowindow, lineN) {
    ...
    for (var i = 0; i < lineNum.length; i++) {
      l = lineNum[i];
      addMarkerWithTimeout(l[0], l[1], l[2], l[3], 1500, infowindow, l[8]);
    }
}
/**************************************************/
/**************************************************
...
function addMarkerWithTimeout(title, position, text, img, timeout, infowindow, link) {
	if (indx != 2){
		indx = 1;
	}
